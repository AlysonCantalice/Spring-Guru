...
import com.alyson.restmvc.mappers.BeerMapper;
...
class BeerControllerIT {
    ...
    void updateExistingBeer() {
        ...
        AssertionsForClassTypes.assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatusCode.valueOf(204));

        Beer updatedBeer = beerRepository.findById(beer.getId()).get();
        AssertionsForClassTypes.assertThat(updatedBeer.getBeerName()).isEqualTo(beerName);
    }
